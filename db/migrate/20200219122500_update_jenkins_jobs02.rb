class UpdateJenkinsJobs02 < ActiveRecord::Migration[5.0]
  ...
  def up
    # Quality Gate
    add_column :jenkins_jobs, :sources_alert_status, :string, null: true, default: nil

    # Size
    add_column :jenkins_jobs, :sources_lines, :bigint, default: 0

    # Reliability
    add_column :jenkins_jobs, :sources_reliability_rating, :string, null: true, default: nil, limit: 1
    add_column :jenkins_jobs, :sources_bugs, :bigint, default: 0

    # Security
    add_column :jenkins_jobs, :sources_security_rating, :string, null: true, default: nil, limit: 1
    add_column :jenkins_jobs, :sources_vulnerabilities, :bigint, default: 0

    # Maintainability
    add_column :jenkins_jobs, :sources_sqale_rating, :string, null: true, default: nil, limit: 1
